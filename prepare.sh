...
run webstorm-2021      kubuntu-24.04
run telegram-desktop   kubuntu-24.04
run oh-my-zsh          kubuntu-24.04

run r8125-dkms         kubuntu-24.04-nodev
run telegram-desktop   kubuntu-24.04-nodev
run oh-my-zsh          kubuntu-24.04-nodev

run oh-my-zsh          ubuntu-24.04-server-rescue

run oh-my-zsh          ubuntu-24.04-server-secured

run rtl8812au-dkms-git ubuntu-24.04-server-nas
